...
for package in packages_to_install:
    ...
    if os.path.exists(package_path):
        installed.append(package)
        print(f"âœ“ Verified installation of {package}")
    else:
        ...
        if os.path.exists(base_path):
            installed.append(package)
            print(f"âœ“ Verified installation of {package} (via {base_package})")
        else:
            failed.append(package)
            print(f"âœ— Failed to verify installation of {package}")
